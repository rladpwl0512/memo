...
function ThirdExperimentDescriptionScreen({ navigation }) {
  ...
  return (
    <View style={[global.container, styles.container]}>
      <Image style={styles.animation} source={require("../assets/animation/third.gif")} />
      <Text style={global.title}>마지막 실험</Text>
      <Text style={[global.content, styles.content]}>
        제시된 목소리와 얼굴 표정을 짝 맞추는 실험입니다.{"\n"}
        {"\n"}목소리를 잘 듣고, 해당 목소리를 낸 것 같은 얼굴을 고르세요.{"\n"}
